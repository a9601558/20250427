...
exports.jsonUploadQuestions = exports.batchUploadQuestions = exports.getBatchQuestionCounts = exports.getQuestionCount = exports.getRandomQuestion = exports.deleteQuestion = exports.updateQuestion = exports.createQuestion = exports.getQuestionById = exports.getQuestions = void 0;
 ...
 * @access Admin
 */
const jsonUploadQuestions = async (req, res) => {
    try {
        ...
        try {
            ...
            const questionSetId = newQuestionSet.get('id') || newQuestionSet.dataValues?.id || newQuestionSet.id;
            ...
            for (let i = 0; i < jsonData.questions.length; i++) {
                ...
                try {
                    ...
                    // 验证答案索引是否有效
                    const invalidAnswers = q.answer.filter((idx) => idx < 0 || idx >= q.options.length);
            ...
            // 更新题库的题目数量
            await QuestionSet.update({ questionCount: successCount }, { where: { id: questionSetId }, transaction });
            // 提交事务
...
exports.jsonUploadQuestions = jsonUploadQuestions;
