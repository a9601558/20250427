...
exports.deleteUser = exports.updateUser = exports.getUserById = exports.getUsers = exports.updateUserProfile = exports.getUserProfile = exports.createOrGetCognitoUser = void 0;
 ...
 */
const createOrGetCognitoUser = async (cognitoUser) => {
    try {
        // 使用Cognito的sub作为用户ID
...
exports.createOrGetCognitoUser = createOrGetCognitoUser;
...
const getUserProfile = async (req, res) => {
    try {
        ...
        if (user) {
            ...
            if (userData.userRedeemCodes) {
                userData.redeemCodes = userData.userRedeemCodes;
                delete userData.userRedeemCodes; // 删除多余字段
            }
            else {
