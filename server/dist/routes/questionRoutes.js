...
router.get('/', authMiddleware_1.optionalAuth, questionController_1.getQuestions); // 可选认证
// 特殊路由放在通用路由前面
...
router.get('/random/:questionSetId', authMiddleware_1.optionalAuth, questionController_1.getRandomQuestion); // 可选认证
...
// 通用路由放在特殊路由后面
router.get('/:id', authMiddleware_1.optionalAuth, questionController_1.getQuestionById); // 可选认证
