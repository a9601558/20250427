...
**MonTopi**（日本語 Topic の略）は、日本語を中心とした多言語対応の試験練習プラットフォームです。AWS Cognitoを活用したセキュアな認証システム、柔軟な題庫管理、リアルタイムの学習進捗追跡機能を提供し、効率的な学習体験を実現します。

### 🎯 主な特徴

- **🌐 多言語対応**: 日本語、日本語、中国語のUI対応
